...
Tests, like always. I need to add unit tests to this project. I also want to fix the jumpy thingy of the data in desktop when you change from one section or planet to the next one. Include Pluto, maybe? I know it's considered a dwarf planet now but I remember when we had 9 planets in the solar system so I kinda have an emotional attachment to that little bugger.
